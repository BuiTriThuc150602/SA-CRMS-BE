...
const EnrollmentPage = () => {
  ...
  useEffect(() => {
    getCourses(semester, student.faculty, student.id);
  }, [semester, student.faculty, student.id]);
  ...
  return (
      <div className="w-screen h-screen font-roboto overflow-y-auto">
        <div
            className="flex justify-center items-center h-[12%] w-full border shadow-lg shadow-[#e4eff5] bg-white ">
          <div className="flex">
            <img
        ...
        <div
            className="flex items-center border bg-white w-full mx-auto px-5 max-w-full overflow-hidden">
          <div
              className="flex w-60 flex-col bg-sky-500 text-white p-2 pl-7 pr-7">
            <p>Xin chào!</p>
            ...
            <div className="flex justify-between">
              <p>Trạng thái:</p>
              <p>
                {student.studentStatus === "ENROLLED" ? "Đang học"
                    : "Tốt nghiệp"}
              </p>
            </div>
        ...
        <div
            className="flex flex-col items-center justify-center border w-full mx-auto px-5 max-w-full overflow-hidden">
          <p className="text-2xl font-bold text-sky-700 mt-2">ĐĂNG KÍ HỌC
            PHẦN</p>
          ...
          <div className="overflow-x-auto mt-3">
            <table className="table border-collapse border border-blue-300">
              ...
              {loading ? (
                  <tr>
                    <td colSpan="4"><span
                        className="loading loading-spinner"></span></td>
                  </tr>
              ) : (
                        ...
                        <td className="border border-blue-300">
                          <div className="flex items-center justify-center">
                            {course?.prerequisiteCourseIds.length > 0 &&
                                course?.prerequisiteCourseIds.map(
                                    (id, index1) => {
                                      return (
            ...
            <table className="table border-collapse border border-blue-300">
              ...
              {error !== "Bad Request" && error !== null && (
                  <div
                    ...
                    <div
                        className="flex flex-col items-center justify-center bg-white p-4 border border-gray-300 shadow-lg rounded">
              ...
              {loadingSchedule ? (
                  ...
                  schedules.map((schedule, index) => (
                      ...
                      >
                        ...
                        <th className="border border-blue-300">
                          <button
                              className="pl-2 pr-2 p-1 boder bg-cyan-600 text-white">
                            Xem
                          </button>
                        </th>
                      </tr>
              ...
              {loadingEnrollment ? (
                  ...
                  enrollments.map((enrollment, index) => (
                      <tr key={index}>
                        ...
                        <th className="border border-blue-300">
                          {formatMoney(enrollment.tuitionFee)}
                        </th>
                        <th className="border border-blue-300">
        ...
        <div
            className="flex flex-col bg-blue-500 mt-2 pt-2 pb-2 text-white items-center justify-center w-[90%] mx-auto">
        ...
        <div
            className="flex flex-col bg-sky-400 pt-2 pb-2 text-white items-center justify-center w-[90%] mx-auto">
